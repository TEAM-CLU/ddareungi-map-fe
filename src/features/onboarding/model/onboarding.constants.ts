export const ONBOARDING_DESCRIPTION_DATA = [
  {
    ...
    text2: '따릉이맵과 함께 탐색해요.',
    imageSource: require('@/assets/imgs/onboarding/onboarding1.png'),
  },
  {
    text1: '루프형 경로 기능으로\n원점과 반환점을 설정해서',
    text2: '돌아올 수 있어요.',
  ...
  {
    text1: '내 위치 기반으로\n가까운 따릉이 대여소를',
    text2: '실시간으로 확인할 수 있어요.',
    imageSource: require('@/assets/imgs/onboarding/onboarding4.png'),
  },
  {
    text1: '실시간 음성 안내로 안전하게 주행해요\n라이딩이 끝나면 이용 기록을',
    text2: '공유할 수 있어요.',
